...
\titlespacing{\section}{0pt}{0pt}{2pt} % Spacing around section titles, the order is: left, before and after
...
\newcommand{\workposition}[5]{
	...
	\expandafter\ifstrequal\expandafter{#4}{}{}{{\raggedright\large\textit{\textbf{#4}}}} % Job title
...
\newcommand{\educationentry}[5]{
	...
	\expandafter\ifstrequal\expandafter{#5}{}{}{& \textit{#5}\\[2pt]} % Institution
}
